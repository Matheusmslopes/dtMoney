  ...
  return (
    <View className="flex-1 bg-gray[1000] p-6">
      ...
      <View className="flex-row gap-4 mt-8">
        <AppButton className="flex-1" widthFull={false} mode="outline" onPress={handleResetFilters}>
          Limpar Filtros
        </AppButton>
        <AppButton className="flex-1" widthFull={false} onPress={handleFetchTransactions}>
          Filtrar
        </AppButton>
      </View>
    </View>
